...
public class AnswerScore_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.AnswerScore");
  ...
  public String getCasProcessorId(int addr) {
      ...
      jcas.throwFeatMissing("casProcessorId", "org.apache.uima.AnswerScore");
  ...
  public int getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "org.apache.uima.AnswerScore");
